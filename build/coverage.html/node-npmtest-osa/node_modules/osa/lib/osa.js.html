...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-osa/node_modules/osa/lib/osa.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-osa">npmtest-osa (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-osa/node_modules/osa/lib/osa.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-osa/node_modules/osa/lib/</a> &#187; osa.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    matches.push(found[1]);</span>
<span class="cstat-no" title="statement not covered" >    reg.lastIndex -= found[0].split(':')[1].length;</span>
  }
&nbsp;
  return matches.length &gt; 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >matches.join('\n') </span>: null;
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          done(null, undefined, log);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          result = JSON.parse(stdout);</span>
<span class="cstat-no" title="statement not covered" >          done(null, result, log);</span>
        }
      // if nothing was in stdout (or it wasn't JSON), something went wrong
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        newErr = new Error('Function did not return an object: ' + e.message);</span>
<span class="cstat-no" title="statement not covered" >        done(newErr);</span>
      }
    }
  });
};
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 18 2017 04:34:17 GMT+0000 (UTC)</div>
</div>
</body>
</html>
